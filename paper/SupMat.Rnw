...
\section{Tail association is not relevant to other mechanisms of coexistence for purely temporal variation}\label{SIsect:other_mechanisms}

%***DAN: Fill this section in. Should be a brief-as-possible definition of the other mechanisms and 
%proof that asymmetries of tail associations won't make a difference. See \ref{Decomposition} for some relevant material.
...
\bibliography{refs}
>>>>>>> 51e4f36ebb5b377c5e7fa08d351b081369763124
