...
Examples of life stages that can buffering against negative growth rates are insensitive adults or dormant seeds that persist even when environmental response amoung others in the population is low (Chesson et al 2012). 
...
[As we know], anthropogenic climate change threatens almost all aspects of life including via extreme climatic events, which have only become more extreme - increasing in magnitude and frequency - and have contributed to both the increase in global means as well as an increase in environmental variability. 
...
Interacting environmental drivers can be asymmetrically related in the extreme values (as shown in Gosh et al 2020 AER). Thus we have implemented our tools for the study ATAs to explore the importance of environmental relationships in their extremes on competition and coexistence. 
Environmental variability has been classically shown to promote coexistence via storage mechanisms in a lottery model of competition (Chesson and Warner 1981, Warner and Chesson 1985), hence we continue/move forward with this simple model to examine the effect of extreme relationships between environmental variables on the contribution of storage effects to coexistence.  
...
(establish criteria for storage effects and establish connection to extreme events to introduce example)
