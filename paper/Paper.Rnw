...
Central to ecology is the maintenance of biodiversity in competitive ecosystems. 
Populations subject to strong competitive pressure may succumb to competitive exclusion - an idea which postulates if species within the same trophic level and similar niches exist, one will eventually outcompete the other (Hardin 1960).
Mediation of competitive pressure and exclusion allow for species to stably coexist. 
The criteria for coexistence and competitive exclusion can be broken down into contributing mechanisms provided by modern coexistence theory, a framework which seeks to assess and quantify mechanisms that result in coexisting species and thus the maintenance of biodiversity (Chesson 1994). 
...
In fact, ATAs can have influence on ecosystem service stability, Taylor’s law, and extinction risks via extreme climatic events. Conversely, ATA’s can be influenced by Moran Effect and Leibeig’s Law of Minimum (Gosh et al 2020 Ecosphere, Gosh et al 2020 And. EcoRes,).
...
Asymmetries in tail associations can potentially influence competition and coexistence via one particular mechanism, namely, storage effects.
Storage effect contributes as a stabilizing mechanism to coexistence when there is covariation between competitive pressures and environmental fluctuations.
Because the contributive value of storage effects relies on the relationship between environment and competition (Chesson 1994, Barbaras ..), it reasonably follows to suspect the contribution of storage effectsto be altered by an association between environment and competition that is asymmetric, i.e., ATAs between environment and competition.
...
Storage effects allow for species to fluctuate over time while escaping extinction. 
In order for storage effect to be a functioning mechanism in coexistence, populations must fluctuate differently in response to environmental fluctuations, there must be a relationship between envrionmental responses and competition, and there must variation in responses at different life history stages. 
In a simple two species system, differences in environmental response allow for one species to grow to high densities while the other is very low. 
Competition is positively related to environmental response for the high density species (species A), stabalizing its growth. 
Conversely, competition is more negatively related to environmental response for the low density species (species B), leading to large fluctuations in population growth rate in both directions. 
Seemingly, this may appear like a scenario for extiction of species B, but it can, in fact, be at an advantage due to differences in life history stages. 
Different responses at different life stages buffer the species against extinction by limiting negative growth rates, but not positive ones. 
Examples of life stages that can buffering against negative growth rates are insensitive adults or dormant seeds that persist even when environmental response amoung others in the population is low (Chesson et al 2012); environment and competiton do not effect the buffered life stages.  
Thus, higher fluctuation in growth rate can lead to a higher long term mean growth rate. 
In this paper, we investigate the consequences of having ATAs in the relationship between fluctuations environmental response and competitive pressure. More specifically, we answer: Does having higher association in a tail end of the EC relationship, while maintaining overall association, change the contribution of storage effect?     
...
There are many studies on the influence of environmental extremes and variability on competition and coexistence (Parepa et al 2013, Diez et al 2012); however, the study of the influence of relationships and interactions between drivers in their extremes on competition and coexistence, is lacking in the scientific literature. 
Interacting environmental drivers can be asymmetrically related in the extreme values (as shown in Gosh et al 2020 AER). 
Environmental drivers directly influence competitive pressure experienced by populations through environmental response; competition is always a function of environmental response (Chesson et al 2012, Ellner et al 2016).
...
Environmental variability has been classically shown to promote coexistence via storage mechanisms in a temporal lottery model of competition (Chesson and Warner 1981, Warner and Chesson 1985), hence we continue/move forward with this simple model to examine the effect of extreme relationships between environmental responses on the contribution of storage effects to coexistence. Moreover, the lottery model within the framework of coexistence theory provides a suitable opportunity to explore relationships in their extremes and the consequences to coexistence. 


To flesh out the idea of how ATAs in environmental response might manifest and modfiy the outcome of coexistence, we introduce an example of a two species grass-forb plant community (inspired by Chesson et al 2012). The community follows the criteria required for temporal storage effects to operate. The forb dominates and has high fecundity when a sufficient threhold of rain is reached in the early season. The grass dominates and has high fecundity when there is sufficeint rain in the late season. Competition is influenced by the resource comsumption of growing juvenile plants. Dormant seeds are unaffected by competiton and unfavorable environment and can persist in the community. When rain conditions fluctuate from year to year, relative abundance and dominance of the grass-forb community also fluctuate year to year. This produces a relationship between the grass's and forb's environmental responses (fecundity) that is symmetrically associated. ATAs in environmental response can be caused by extreme climatic events. If the community is affected by frequent and long drought with some years of normalcy, the grass-forb environmental response relationship may become more correlated in the lower values or left tail associated. Conversely, if the community is effected by frequent and long floods with some years of normalcy, the grass-forb environmental relationship may become more correlated in the higher values or right-tail associated. In Figure 2 we see a possible outcome of ATAs between environmental responses. In simulating their populations,  ATAs can cause species to have longer periods of extreme dominance and lower growth rates overall.      

Previously, storage effects were described as the contribution of covariance between the environment and competition to coexistence (Chesson et al 2012, Ellner et al 2016, Ellner at al 2019). 
However, the description of storage effects as the covariance between drivers is a (potentially dangerous/irresponsible?) misnomer in terminology, and we argue that storage effects, instead, should be described as the contribution of the relationship between drivers. 
...
Thus, aligning with the decomposition presented in Ellner et al (2019), we propose storage effect can be broken down further into the contribution of ATA [to storage effect/coexistence] and the contribution of symmetric association [to storage effect/coexistence].
