...
We emphasize that although this paper focuses on storage effects, it is still a paper generally about the importance of ATAs for coexistence because we do consider whether they are important for other mechanisms of modern coexistence theory, though we quickly realize their importance is solely for storage effects. 
Storage effects allow for species to fluctuate over time while escaping extinction. In order for storage effect to be a functioning mechanism in coexistence populations must fluctuate differently in resonse to environmental fluctuations, there must be a relationship between envrionmental responses and competition, and there must variation in responses at different life history stages. In a simple two species system, differences in environmental response allows for one species to grow to high densities while the other is very low. Competition is positively related to environment for the high density species (species A), stabalizing its growth. Conversely, competition is negatively/less positively?/more negative? related to environment for the low density species (species B), leading to large population growth rate fluctuations in both directions. At first glance, this may seem like a scenario for extiction of species B, but it can, in fact, be at an advantage due to the differences in life history stages. Different responses at different stages of life buffer the species against extinction by limiting negative growth rates, but not positive ones. Buffering against negative growth rates can be seen in insensitive adults or dormant seeds that persist even when environmental response amoung others in the population is low (Chesson et al 2012). Thus, higher fluctuation in growth rate can lead to a higher long term mean growth rate. In this paper, we investigate the consequences of having ATAs in the relationship between environmental fluctuations and competitive pressure. More specifically, we answer: Does having higher association in a tail end of the EC relationship, while maintaining overall association, change the contribution of storage effect?     

    

[As we know], anthropogenic climate change has large consequences for almost all aspects of life including via extreme climatic events, which have only become more extreme - increasing in magnitude and frequency - and have contributed to both the increase in global means as well as an increase in environmental variability. 
