...
applied to quite a few empirical systems, including annual plants \citep{Angert_2009, Hallett_2019}, perennial plants \citep{Adler_2010}, tropical trees \citep{Usinowicz_2012}, plankton \citep{Narawani_2013, Caceres_1997}, and corals \citep{}. 
...
If extreme events are more temporally extensive/expansive than regular environmental fluctuations, extreme events may cause the environmental response of two species who depend on temporally separated indicators of growth to become more correlated in the extremes. For example, ...
