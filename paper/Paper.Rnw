...
The maintenance of biodiversity in competitive ecosystems is a research topic at the absolute core of modern ecology.
...
applied to quite a few empirical systems, including annual plants \citep{Angert_2009}, Y and Z, 
...
considered in ecology and related areas (but see REFS), 
