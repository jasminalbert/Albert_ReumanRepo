...
Although, this may appear like a scenario for extiction, it can, in fact, be advantageous due to differences between life stages, which buffer the species against extinction by limiting negative growth rates, but not positive ones. 
