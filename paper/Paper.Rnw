...
Thus, following the decomposition presented in Ellner et al (2019), we propose storage effect can be broken down further into the contribution of ATAs [to storage effect/coexistence] and the contribution of symmetric association [to storage effect/coexistence].
