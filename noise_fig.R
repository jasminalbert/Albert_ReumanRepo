...
plot(b$b_l[,1],b$b_l[,2], col="darkblue", ylab=expression(b[2]), xlab=NA, xlim=c(-4,4), ylim=c(-4,4),main='Left-tailed', cex.lab=1.5)
plot(b$b_s[,1],b$b_s[,2], col="darkblue", xlab=expression(b[1]), ylab=NA, xlim=c(-4,4), ylim=c(-4,4),main='Symmetric',cex.lab=1.5)
