...
png("figure2.1.1.PNG", width=1000, height=600, pointsize=15)
...
png("figure2.1.2.PNG", width=1000, height=600, pointsize=15)
par(mfrow=c(2,1), mar=c(3,3,1,1), oma=c(2,1,1,1))
...
#also max r
png("figure2.3.1.PNG", width=1000, height=600, pointsize=15)
par(mfrow=c(2,1), mar=c(3,3,1,1), oma=c(2,1,1,1))
...
#min r (negative)
png("figure2.4.1.PNG", width=1000, height=600, pointsize=15)
par(mfrow=c(2,1), mar=c(3,3,1,1), oma=c(2,1,1,1))
